        ...
        <div class="mt-10 sm:mt-0">
            ...
            <div class="mt-5 md:mt-6 md:col-span-4">
                <div class="md:col-span-1">
                    ...
                    <h3 class="text-lg font-medium leading-6 text-white">Raise your concern here</h3>
                    ...
                    <div class="shadow overflow-hidden sm:rounded-md">
                        ...
                        <div class="grid grid-cols-6 gap-6">
                           ...
                           <div class="col-start-1 col-end-5">
                            <label for="issueDate" class="formLable">issue Date</label>
                            <input type="date" name="issueDate" id="issueDate"  defaultValue={ issueDate } onSelect={(e) =>{setissueDate(e.target.value)}} required  
                            ...
                            <div class="col-start-1 col-end-5">
                            <label for="tel" class="formLable">Contact Number</label>
                            ...
                            <div class="col-start-1 col-end-5">
                            <label for="inquiry" class="formLable">Inquiry type</label>
                            <select id="inquiry" name="inquiry" Value={ inquiry } onChange={e =>{setinquiry(e.target.value)}} placeholder="Select inquiry" required 
                                ...
                                <option>I have a concern about an Item purchased</option>
                                <option>I have a question about the services you offer</option>
                                <option>Other</option>
                            ...
                            <div class="col-start-1 col-end-5">
                            <label for="subject" class="formLable">Subject</label>
                            <input type="text" name="subject" id="subject" maxlength="30" defaultValue={ subject } onSelect={(e) =>{setsubject(e.target.value)}} required 
                                className= {`${styles.ADtxt}`}/>
                            ...
                            <div class="col-start-1 col-end-5">
                            <label for="description" class="formLable">Message</label>
                            <textarea  class="block p-30 w-full   rounded-lg border  sm:text-md  "  name="description" id="description" maxlength="100"  defaultValue={ description } onSelect={(e) =>{setdescription(e.target.value)}} required  
                                className= {`${styles.ADtxt}`}></textarea>
                            </div>
