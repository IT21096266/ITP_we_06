...
const SupplierList = ({getSupplierId}) => {
  ...
  return (
      <Helmet title="Supplier List">
        <section id='SupplierList' className={`flex md:flex-row flex-col ${styles.paddingY}`}>
            <div className={`flex-1 ${styles.flexStart} flex-col xl:px-0 sm:px-16 px-6 bg-discount-gradient rounded-md`}>
                
                <div class="overflow-x-auto relative">
                <button className= {`${styles.ALbtn} font-semibold`} onClick={ navigateSupplierForm }>
                  Add New Supplier
                </button>
                    <table className= {`${styles.ALtable}`}>
                        <thead className= {`${styles.ALthread}`}>
                            <tr>
                                <th scope="col" className= {`${styles.ALth}`}>ID</th>
                                <th scope="col" className= {`${styles.ALth}`}>Name</th>
                                <th scope="col" className= {`${styles.ALth}`}>Country</th>
                                <th scope="col" className= {`${styles.ALth}`}>Address</th>
                                <th scope="col" className= {`${styles.ALth}`}>Postal Code</th>
                                <th scope="col" className= {`${styles.ALth}`}>Email</th>
                                <th scope="col" className= {`${styles.ALth}`}>Phone</th>
                                <th scope="col" className= {`${styles.ALth}`}>Action</th>
                            </tr>
                        </thead>
                        <tbody>
