...
// navigate to /contacts
    ...
    return (
        ...
        <div class="overflow-x-auto relative">
             <div class="flex justify-center ..."><button className= {`${styles.ALbtn}`} onClick={ navigateEmployee}>
                                Add New Employee
                            </button></div>
                            <br></br>
                            <div class="flex justify-center ..."><button className= {`${styles.ALbtn}`} onClick={ navigateEmployeeSalary}>
                                Salary Calculator
                            </button></div>
            ...
            <table className= {`${styles.ALtable}`}>
                <thead className= {`${styles.ALthread}`}>
                    ...
                    <tr>
                        <th scope="col" className= {`${styles.ALth}`}>ID
                           
                        </th>
                        <th scope="col" className= {`${styles.ALth}`}> First NAME
                        </th>
                        <th scope="col" className= {`${styles.ALth}`}>LAST NAME
                        </th>
                        <th scope="col" className= {`${styles.ALth}`}>CITY
                        </th>
                        <th scope="col" className= {`${styles.ALth}`}>Position
                        </th>
                        <th scope="col" className= {`${styles.ALth}`}>Salary
                        </th>
                        <th scope="col" className= {`${styles.ALth}`}>MOBILE Number
                        </th>
                    </tr>
                </thead>
                <tbody>
