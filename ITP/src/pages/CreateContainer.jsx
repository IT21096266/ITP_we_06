...
const CreateContainer = () => {
  ...
  const saveDetails = () => {
    setLoading(true)
    try {
      if((!brand || !category || !price || !quantity || !discription || !imageAsset)){
        setFields(true)
  ...
  return (
    ...
    {/*-------------- Messages -------------*/}
                ...
                <div className='bg-gray-gradient mt-1 mb-20 p-12 w-[75%] border boader-gray-200 
                  ...
                  <div className='w-full py-2 border-b border-gray-400 flex items-center'>
                    ...
                    <div className=' mt-14 w-full py-2 flex items-center gap-2'>
                      <label className="block text-lg font-medium text-gray-300 ">Brand Name: </label>
                    ...
                    <div className='mt-3 w-full'>
                      <label className=" block text-lg font-medium text-gray-300 ">Select Item Category: </label>
                          ...
                          <select onChange={(e) => setCategory(e.target.value)} 
                            ...
                            <option value='other' className='bg-white' > Select Category </option>
                              {categories && categories.map(item =>(
                                <option key={item.id} className='text-base boader-0 outline-none capitalize bg-white text-headingColor '
                    ...
                    <div className='mt-4 w-full flex flex-col md:flex-row items-center'>
                      <div className='w-full py-2 flex items-center gap-2'>
                        <label className="block text-lg font-medium text-gray-300 ">Item Quantity: </label>
                    ...
                    <div className='mt-4 w-full flex flex-col md:flex-row items-center'>
                      <div className='w-full py-2 flex items-center gap-2'>
                        <label className="block text-lg font-medium text-gray-300 ">Price of the Item: </label>
                    ...
                    <div className='mt-4 w-full flex flex-col md:flex-row items-center'>
                      <div className='w-full py-2 flex items-center gap-2'>
                        <label className="block text-lg font-medium text-gray-300 ">Discription of the Item: </label>
                          <textarea placeholder="Discription here"
                                    required value={discription}
      ...
      {/*-------------- Image Uploader -------------*/}      
                                    ...
                                    <label className='w-full h-full flex flex-col items-center justify-center cursor-pointer'>
                                      <div className='w-full h-full flex flex-col items-center justify-center'>
                                        <MdCloudUpload className='text-gray-400 text-[50px] hover:text-gray-600' />
                                          <p className='text-gray-400 hover:text-gray-600'> Click here to Upload </p>
                                      </div>
                    ...
                    <div className='mt-4 flex items-center w-full'>
                      <button type="button"onClick={ saveDetails } className='ml-0 md:ml-auto boader-none outline-none
