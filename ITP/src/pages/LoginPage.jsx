                ...
                <div className="w-full bg-box-gradient rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 ">
                    <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                        ...
                        <form className="space-y-4 md:space-y-6">
                            <div>
                                <label htmlFor="email" className="block mb-2 text-sm font-medium text-gradient dark:text-white">Your email</label>
                            ...
                            <div>
                                <label htmlFor="password" className="block mb-2 text-sm font-medium text-gradient dark:text-white">Password</label>
                            ...
                            <div className="flex items-center justify-between">
                                ...
                                <a href="#" className="text-sm font-medium text-dimWhite hover:underline dark:text-primary-500">
                                    Forgot password?
                                </a>
                            </div>
                            ...
                            <p className="text-sm font-light text-gray-500 dark:text-gray-400">
                                ...
                                <a href="/signup" className="font-medium text-primary-600 hover:underline dark:text-primary-500 ml-3">
                                    Sign up
                                </a>
                            </p>
                        </form>
