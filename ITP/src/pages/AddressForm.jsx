                        ...
                        <div className="mt-10 sm:mt-0">
                            <div className="md:grid md:grid-cols-3 md:gap-6">
                                <div className="md:col-span-1">
                                    ...
                                    <h3 className="text-lg font-medium leading-6 text-white">Address Log</h3>
                                ...
                                <div className="mt-5 md:mt-0 md:col-span-2">
                                    <form onSubmit={handleSubmit} className='bg-box-gradient text-black'>
                                    <div className="shadow overflow-hidden sm:rounded-md">
                                        ...
                                        <div className="grid grid-cols-6 gap-6">
                                            ...
                                            <input type="number" name="postal_code" id="postal_code" maxLength="5" pattern="[0-9]{5}" defaultValue={ zipCode } onChange={(e) =>{setZipCode(e.target.value)}} required  
                                                className= {`${styles.ADtxt}`}/>
                                            </div>
