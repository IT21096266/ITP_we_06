        ...
        <div class="mt-10 sm:mt-0">
            <div class="md:grid md:grid-cols-3 md:gap-6">
                <div class="md:col-span-1">
                    ...
                    <center><h3 class="text-lg font-high leading-20 text-white">  ADD NEW EMPLOYEES  </h3></center>
                ...
                <div class="mt-5 md:mt-0 md:col-span-2">
                    ...
                    <div class="shadow overflow-hidden sm:rounded-md">
                        ...
                        <div class="grid grid-cols-6 gap-6">
                            ...
                            <label for="position" class="formLable">position</label>
                            <input type="text" name="position" id="position" maxlength="15" defaultValue={ position } onSelect={(e) =>{setPosition(e.target.value)}} required  
                                className= {`${styles.ADtxt}`}/>
                            </div>

                            <div class="col-span-6 sm:col-span-6">
                            <label for="salary" class="formLable">salary</label>
                            <input type="text" name="salary" id="salary" maxlength="30" defaultValue={ salary } onSelect={(e) =>{setSalary(e.target.value)}} required  
                                className= {`${styles.ADtxt}`}/>
                            </div>
