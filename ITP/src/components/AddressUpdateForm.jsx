        ...
        <div class="mt-10 sm:mt-0">
            <div class="md:grid md:grid-cols-3 md:gap-6">
                <div class="md:col-span-1">
                    ...
                    <h3 class="text-lg font-medium leading-6 text-gray-900">Update Address Log</h3>
            ...
            <div class="shadow overflow-hidden sm:rounded-md">
                <div class="px-4 py-5 bg-white sm:p-6">
                    <div class="grid grid-cols-6 gap-6">
                        ...
                        <input type="text" name="first_name" id="first_name" Value={ firstName } onSelect={(e) =>{setFirstName(e.target.value)}} required  class="mt-1 block w-full shadow-sm sm:text-sm border-gray-600 rounded-md h-8 box-border hover:box-content hover:bg-slate-100 duration-500 "/>
                        </div>
        
                        <div class="col-span-6 sm:col-span-3">
                        <label for="last_name" class="formLable">Last name</label>
                        <input type="text" name="last_name" id="last_name" Value={ lastName } onSelect={(e) =>{setLastName(e.target.value)}} required  class="mt-1 block w-full shadow-sm sm:text-sm border-gray-600 rounded-md h-8 box-border hover:box-content hover:bg-slate-100 duration-500"/>
                        </div>

                        <div class="col-span-6 sm:col-span-3">
                        <label for="house_no" class="formLable">House No</label>
                        <input type="text" name="house_no" id="house_no" Value={ houseNo } onSelect={(e) =>{setHouseNo(e.target.value)}} required  class="mt-1 block w-full shadow-sm sm:text-sm border-gray-600 rounded-md h-8 box-border hover:box-content hover:bg-slate-100 duration-500"/>
                        </div>

                        <div class="col-span-6 sm:col-span-3">
                        <label for="street_address" class="formLable">Street address</label>
                        <input type="text" name="street_address" id="street_address" Value={ streetName } onSelect={(e) =>{setSreetName(e.target.value)}} required  class="mt-1 block w-full shadow-sm sm:text-sm border-gray-600 rounded-md h-8 box-border hover:box-content hover:bg-slate-100 duration-500"/>
                        </div>

                        <div class="col-span-6 sm:col-span-3 lg:col-span-2">
                        <label for="City" class="formLable">City</label>
                        <input type="text" name="City" id="City" Value={ cityName } onSelect={(e) =>{setCityName(e.target.value)}} required class="mt-1 block w-full shadow-sm sm:text-sm border-gray-600 rounded-md h-8 box-border hover:box-content hover:bg-slate-100 duration-500"/>
                        </div>
        
                        <div class="col-span-6 sm:col-span-3 lg:col-span-2">
                        <label for="postal_code" class="formLable">ZIP / Postal</label>
                        <input type="text" name="postal_code" id="postal_code" Value={ zipCode } onSelect={(e) =>{setZipCode(e.target.value)}} required class="mt-1 block w-full shadow-sm sm:text-sm border-gray-600 rounded-md h-8 box-border hover:box-content hover:bg-slate-100 duration-500"/>
                        </div>
                        ...
                        <input type="text" name="District" id="District" Value={ district } onSelect={(e) =>{setDistrict(e.target.value)}} required class="mt-1 block w-full shadow-sm sm:text-sm border-gray-600 rounded-md h-8 box-border hover:box-content hover:bg-slate-100 duration-500"/>
                        </div>

                        <div class="col-span-8 sm:col-span-4">
                        <label for="tel" class="formLable">Mobile Number</label>
                        <input type="tel" name="tel" id="tel" Value={ mNumber } onSelect={(e) =>{setMnumber(e.target.value)}} required placeholder="07xxxxxxxx" pattern="[0-9]{10}" class="mt-1 block  shadow-sm sm:text-sm border-gray-600 rounded-md h-8 box-border hover:box-content hover:bg-slate-100 duration-500"/>
                        </div>
